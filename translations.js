const translations = {
    'pt': {
        ...
        'nav-home': 'Início',
        'nav-join': 'Junta-te',
        'nav-projetos': 'Projectos',
        'nav-contacts': 'Contactos',
        'nav-donativos': 'Donativos',
        ...
        'about-description': 'O Centro Académico Tradicionalista (C.A.T.) é uma corporação de estudantes tradicionalistas, voltada para unir os tradicionalistas e promover os valores catholicos e portuguezes, por via de coloquios, conferências, palestras, Grémios litterarios e outros.',
        'download-values': 'Descarregar a Carta de Princípios',
        'feature-1-title': 'Leicturas',
        'feature-2-title': 'Comunidade',
        'feature-3-title': 'Contra-Revolução',
        'feature-1-desc': 'Ajudamos e estudamos obras litterarias portuguezas e da Egreja.',
        'feature-2-desc': 'Temos uma comunidade activa e participactiva entre vários estudantes da Universidade de Lisboa.',
        'feature-3-desc': 'Somos Nacionalistas por princípio, Corporativistas por meio e Monarchicos por fim.',
        ...
        'events-hero-subtitle': 'Descubra as nossas actividades e encontros',
        'past-and-future': 'Próximos e Passados',
        'past-and-future-subtitle': 'Conheça os eventos organizados pelo Centro Académico Tradicionalista',
        'all': 'Todos',
        'future': 'Próximo',
        'past': 'Passado',
        'no-events-title': 'Nenhum evento encontrado',
        'no-events-description': 'Estamos a preparar actividades futuras. Fique atento às nossas redes sociaes para novidades.',
        'ask-event-title': 'Proponha um Evento',
    ...
    'en': {
        ...
        'feature-3-title': 'Counter-Revolution',
        ...
        'feature-3-desc': 'We are Nationalists in principle, Corporatists in means and Monarchists in end',
        'join-button': 'Join Us',
        ...
        'events-hero-subtitle': 'Discovery our activities and hangouts',
        'past-and-future': 'Upcoming and Past',
        'past-and-future-subtitle': 'Discover the events organized by the Traditionalist Academic Center',
        'all': 'All',
        'future': 'Upcoming',
        'past': 'Past',
        'no-events-title': 'No events found',
        'no-events-description': 'We are preparing future activities. Stay tuned to our social media for updates.',
        'ask-event-title': 'Propose an event',
